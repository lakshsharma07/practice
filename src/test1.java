...
public class test1 {
	public static void main(String argv[]) {
		try {
			...
			// parsing an XML file
			File file = new File("D:\\CitiConnectWorkSpace\\Test\\src\\test.xml");
			...
			/*
			 * here normalize method Puts all Text nodes in the full depth of the sub-tree
			 * underneath this Node, including attribute nodes, into a "normal" form where
			 * only structure separates Text nodes, i.e., there are neither adjacent Text
